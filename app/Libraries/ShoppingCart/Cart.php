...
use App\Libraries\ShoppingCart\Exceptions\CartAlreadyStoredException;
use App\Libraries\ShoppingCart\Exceptions\UnknownModelException;
use Closure;
...
class Cart
{
     ...
     * @return \App\Libraries\ShoppingCart\Cart
     */
     ...
     * @return \App\Libraries\ShoppingCart\CartItem
     */
    ...
    public function content()
    {
        ...
        foreach ($content as $key => $item) {
            $product = \App\Models\ShopProduct::where('id', $item->id)
