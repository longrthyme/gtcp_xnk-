...
use App\Admin\Models\AdminPackageOption;

class AdminPackageOptionController extends Controller
{
    public $admin_path = 'admin.package';
    public $title_head;
    public $categories;
    /**
     ...
     * @return void
     */
    public function __construct(AdminPackageOption $tableModel){
        $this->title_head = 'Tùy chọn đăng tin';
        $this->tableModel = $tableModel;
        $this->categories = (new AdminPackageOption)->getTreeCategoriesAdmin();
    }
    ...
    public function index(){
        ...
        $dataReponse = [
            ...
            'url_action'  => route('admin_package.option_post'),
        ];

        return view($this->admin_path .'.option', $dataReponse);
    }
    ...
    public function store(Request $rq){
        ...
        if($save=='apply'){
            ...
            $url = route('admin_package.option_edit', array($post_id));
            Helpers::msg_move_page($msg, $url);
        }
        else
            return redirect(route('admin_package.option'));
    }
