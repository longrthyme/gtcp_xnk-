...
use App\Models\XNKCategoryDescription;

class AdminXNKCategory extends XNKCategory
{
    ...
    public static function getCategoryListAdmin(array $dataSearch)
    {
        ...
        $tableDescription = (new XNKCategoryDescription)->getTable();
        $tableCategory     = (new XNKCategory)->getTable();

        $categoryList = (new XNKCategory)
    ...
    {
        $tableDescription = (new XNKCategoryDescription)->getTable();
        $table = (new XNKCategory)->getTable();
    ...
    {
        return XNKCategoryDescription::create($dataInsert);
    }
}
