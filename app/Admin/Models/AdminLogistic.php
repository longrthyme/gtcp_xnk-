...
use App\Models\LogisticDescription;
use App\Models\LogisticCategoryJoin;

class AdminLogistic extends Logistic
{
    /**
    ...
    {
        return LogisticDescription::create($dataInsert);
    }
