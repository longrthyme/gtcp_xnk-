...
class Post extends Model
{
    ...
    {
        return $this->hasMany(PostDescription::class, 'post_id', 'id');
    }
    ...
    public function categories(){
        return $this->belongsToMany(PostCategory::class, 'post_category_join', 'post_id', 'category_id');
    }
