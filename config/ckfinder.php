...
$config['licenseName'] = 'gtcplatform.com';
$config['licenseKey']  = 'GWUWYMY5BBHHCCRTPGN8LTJDMXNHC';
...
// echo public_path('js/ckfinder/plugins') ; die;
$config['pluginsDirectory'] = public_path('js/ckfinder/plugins');
