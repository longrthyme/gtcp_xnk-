            ...
            <table class="table table-bordered" id="table_index">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin_logistic.edit', $item->id) }}" title=""><b>{{ $item->name }}</b></a>
                            <div>
                        ...
                        <td>
                            ...
                            @foreach($categories as $index => $category)
                                @if($index > 0), @endif
                                <a href="{{ route('admin_logistic.category_edit', $category->id) }}" target="_blank">{{ $categoriesTitle[$category->id] }}</a>
                            @endforeach
                        </td>
                        <td class="text-center">
                            @if($item->image)
