                            ...
                            <table class="table table-bordered" id="table_index">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ !empty($id) && $id == $item->id ? 'active' : '' }}">
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('admin_package.option_edit', array($item->id))}}"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="text-danger ml-2" href="{{ route('admin_package.option_delete', $item->id) }}"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @if($childs)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group text-end m-b-0">
                                <a class="btn btn-secondary btn-sm" href="{{ route('admin_package.option') }}">Danh sách</a>
                                @if(!empty($id))
