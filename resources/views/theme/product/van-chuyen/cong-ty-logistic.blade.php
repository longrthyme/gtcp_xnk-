                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="shop-sidebar">
                                @includeIf($templatePath .'.product.filter-option',['id' => 104])
                                @includeIf($templatePath .'.product.filter-option',['id' => 126])
                                @includeIf($templatePath .'.product.filter-option',['id' => 147])
                                @includeIf($templatePath .'.product.filter-option',['id' => 75])
                            </div>
                        </div>
