...
@section('content')
    @php        
        ...
        if($category->slug != 'yeu-cau-chao-gia')
                ...
                <div class="page-wrapper">
                    <div class="row">
                        <div class="col-12 mx-auto">
                            @includeIf($templatePath .".product.$slug.filter-top")

                            <div class="product-list">
                                @php
                                    $templatePath_category = $templatePath .".product.$slug.";

                                    $templatePath_1 = $templatePath_category . $category_first->slug."-list";
                                    $templatePath_2 = $templatePath_category ."product-list";
                                @endphp
