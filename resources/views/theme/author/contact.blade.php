                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 mx-auto">
                            <div class="bg-white p-3">
                                <form action="" method="POST" class="position-relative border p-3" id="form-baogia" enctype="multipart/form-data">
                                    @csrf()
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-textarea">
                                                ...
                                                <textarea rows="5" name="content" class="form-control content-limit" data-limit="1500" required>{{ old('content') }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <label class="mb-1">File đính kèm (<10MB)</label>
                                            <input type="file" name="request_file" class="form-control">
                                            @if ($errors->has('request_file'))
                                                <div class="help-block error">{{ $errors->first('request_file') }}</div>
                                            @endif
                                        </div>
